...
if ($_POST["JQueryFunction"] == 'cadastrarTiposDeMercadoria') {
    $response = array();

    $descricao = $_POST['descricao'];

    $query = "INSERT INTO EST_TIPOS_MERCADORIA (DESCRICAO, INCLUIDOPOR, INCLUIDOEM, EMPRESA_ID)
...
if ($_POST["JQueryFunction"] == 'editarTiposDeMercadoria') {
    $response = array();
    ...
    $query = "UPDATE EST_TIPOS_MERCADORIA SET
    DESCRICAO = '$descricao',
...
if ($_POST["JQueryFunction"] == 'deletarTipoDeMercadoria') {
    $response = array();
